...
// ============================================================================
const flightDataset = [
  { flightNo: "EK 542", airline: "Emirates", origin: "Dubai (DXB)", eta: "02:30", frequency: "Daily", status: "Active" },
  { flightNo: "6E 1472", airline: "IndiGo", origin: "Dubai (DXB)", eta: "02:35", frequency: "Mon, Tue, Wed, Thu, Sat, Sun", status: "Active" },
  { flightNo: "6E 1002", airline: "IndiGo", origin: "Singapore (SIN)", eta: "06:15", frequency: "Daily", status: "Active" },
  { flightNo: "6E 1032", airline: "IndiGo", origin: "Kuala Lumpur (KUL)", eta: "06:55", frequency: "Daily", status: "Active" },
  { flightNo: "AK 11", airline: "AirAsia", origin: "Kuala Lumpur (KUL)", eta: "07:25", frequency: "Daily", status: "Active" },
  { flightNo: "EK 544", airline: "Emirates", origin: "Dubai (DXB)", eta: "08:05", frequency: "Daily", status: "Active" },
  { flightNo: "SQ 524", airline: "Singapore Airlines", origin: "Singapore (SIN)", eta: "09:20", frequency: "Daily", status: "Active" },
  { flightNo: "UL 121", airline: "SriLankan Airlines", origin: "Colombo (CMB)", eta: "10:15", frequency: "Daily", status: "Active" },
  { flightNo: "MH 182", airline: "Malaysia Airlines", origin: "Kuala Lumpur (KUL)", eta: "10:45", frequency: "Daily", status: "Active" },
  { flightNo: "6E 1062", airline: "IndiGo", origin: "Bangkok (BKK)", eta: "11:00", frequency: "Daily", status: "Active" },
  { flightNo: "6E 1026", airline: "IndiGo", origin: "Singapore (SIN)", eta: "12:45", frequency: "Daily", status: "Active" },
  { flightNo: "6E 1174", airline: "IndiGo", origin: "Colombo (CMB)", eta: "15:40", frequency: "Daily", status: "Active" },
  { flightNo: "EK 546", airline: "Emirates", origin: "Dubai (DXB)", eta: "20:30", frequency: "Daily", status: "Active" },
  { flightNo: "TR 578", airline: "Scoot", origin: "Singapore (SIN)", eta: "21:20", frequency: "Daily", status: "Active" },
  { flightNo: "SQ 528", airline: "Singapore Airlines", origin: "Singapore (SIN)", eta: "22:00", frequency: "Daily", status: "Active" },
  { flightNo: "MH 180", airline: "Malaysia Airlines", origin: "Kuala Lumpur (KUL)", eta: "22:50", frequency: "Daily", status: "Active" },
  { flightNo: "AK 13", airline: "AirAsia", origin: "Kuala Lumpur (KUL)", eta: "23:05", frequency: "Daily", status: "Active" },
  { flightNo: "TG 337", airline: "Thai Airways", origin: "Bangkok (BKK)", eta: "23:45", frequency: "Daily", status: "Active" }
];

let flightAirlineFilter, flightSearchInput, flightsTableBody;

function initFlightSchedule() {
  flightAirlineFilter = document.getElementById('flightAirlineFilter');
  ...
  flightAirlineFilter.addEventListener('change', renderFlightsTable);
    ...
    if (matchAirline && matchSearch) {
      html += `
        <tr>
          ...
          <td style="padding: 12px 10px; border-bottom: 1px solid var(--border-color); font-family: var(--font-mono);">${f.eta}</td>
          <td style="padding: 12px 10px; border-bottom: 1px solid var(--border-color); font-size: 13px;">${f.frequency}</td>
          <td style="padding: 12px 10px; border-bottom: 1px solid var(--border-color);"><span class="badge-success badge">${f.status}</span></td>
        </tr>`;
    }
  });

  if (!html) {
    html = `<tr><td colspan="5" style="text-align: center; padding: 24px; color: var(--text-muted);">No flights matching search criteria.</td></tr>`;
  }
